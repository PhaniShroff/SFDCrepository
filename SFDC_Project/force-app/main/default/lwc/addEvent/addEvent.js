...
export default class AddEvent extends NavigationMixin(LightningElement) {
    ...
    handleClick(){
        const fields = {};
        fields[Name__c.fieldsApiName] = this.eventRecord.Name;
        fields[Start_DateTime__c.fieldsApiName] = this.eventRecord.Start_DateTime__c;
        fields[End_Date_Time__c.fieldsApiName] = this.eventRecord.End_Date_Time__c;
        fields[Max_Seats__c.fieldsApiName] = this.eventRecord.Max_Seats__c;
        fields[Event_Detail__c.fieldsApiName] = this.eventRecord.Event_Detail__c;
